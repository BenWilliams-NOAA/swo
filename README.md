...
A basic walk through that shows how to query the data for the GOA and run simulations is available as an [article](https://benwilliams-noaa.github.io/swo/articles/example.html).
